 ...
 * mode (V1) after bundling. Functions are split into two buckets — ones from
 * the user's own repository and ones generated by frameworks — because the
 * action the user can take differs.
 */
export const logLambdaCompatibilityDeprecation = ({
  ...
  // Lambda compatibility mode only exists for JavaScript/TypeScript functions.
  // Go functions are intentionally not flagged — they remain Lambda-style and
  // are not affected by the V1 deprecation.
