...
export const reportValidations = async function ({
  ...
  try {
    // @ts-expect-error Property 'updateDeployValidations' does not exist on type 'NetlifyAPI'. This is a private/internal-only method and isn't generated in the type definitions.
