...
> Snapshot 1
    ...
    ␊
    ────────────────────────────────────────────────────────────────␊
      3. onPreBuild step from ./three.js                            ␊
    ────────────────────────────────────────────────────────────────␊
    ␊
    ␊
    ...
    ␊
    ────────────────────────────────────────────────────────────────␊
      4. onPreBuild step from ./four.js                             ␊
    ────────────────────────────────────────────────────────────────␊
    ␊
    ␊
...
> Snapshot 1
    ...
    ␊
      In file "packages/build/tests/status/fixtures/core_command_error/functions/function.js"␊
...
> Snapshot 1
    ...
    ␊
    ────────────────────────────────────────────────────────────────␊
      1. onSuccess step from ./plugin.js                            ␊
    ────────────────────────────────────────────────────────────────␊
    ␊
    ␊
    ────────────────────────────────────────────────────────────────␊
