...
> Snapshot 1
    ...
    ␊
    ────────────────────────────────────────────────────────────────␊
      1. onSuccess command from ./plugin.js                         ␊
    ────────────────────────────────────────────────────────────────␊
    ␊
    ␊
    ────────────────────────────────────────────────────────────────␊
...
> Snapshot 1
    ...
    ␊
    ────────────────────────────────────────────────────────────────␊
      1. onPreBuild command from ./one.js                           ␊
    ────────────────────────────────────────────────────────────────␊
    ␊
    ␊
    ...
    ␊
    ────────────────────────────────────────────────────────────────␊
      2. onPreBuild command from ./two.js                           ␊
    ────────────────────────────────────────────────────────────────␊
    ␊
    ␊
    ...
    ␊
    ────────────────────────────────────────────────────────────────␊
      3. onPreBuild command from ./three.js                         ␊
    ────────────────────────────────────────────────────────────────␊
    ␊
    ␊
    ...
    ␊
    ────────────────────────────────────────────────────────────────␊
      4. onPreBuild command from ./four.js                          ␊
    ────────────────────────────────────────────────────────────────␊
    ␊
    ␊
...
> Snapshot 1
    ...
    ␊
    ────────────────────────────────────────────────────────────────␊
      1. onPreBuild command from ./two.js                           ␊
    ────────────────────────────────────────────────────────────────␊
    ␊
    ␊
    ────────────────────────────────────────────────────────────────␊
...
> Snapshot 1
    ...
    > Resolved config␊
      build:␊
        functions: packages/build/tests/status/fixtures/core_command_error/functions␊
    ␊
    > Context␊
      production␊
    ␊
