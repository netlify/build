...
## constants.INTERNAL_EDGE_HANDLERS_SRC default value
...
> Snapshot 1
    ...
    > Flags␊
      debug: true␊
      repositoryRoot: packages/build/tests/constants/fixtures/internal_edge_handlers_src␊
      testOpts:␊
        pluginsListUrl: test␊
        silentLingeringProcesses: true␊
    ␊
    > Current directory␊
      packages/build/tests/constants/fixtures/internal_edge_handlers_src␊
    ␊
    > Config file␊
      packages/build/tests/constants/fixtures/internal_edge_handlers_src/netlify.toml␊
    ␊
    > Resolved config␊
      build:␊
        publish: packages/build/tests/constants/fixtures/internal_edge_handlers_src␊
        publishOrigin: default␊
      plugins:␊
        - inputs: {}␊
          origin: config␊
