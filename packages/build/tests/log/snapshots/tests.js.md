...
> Snapshot 1
    ...
    > Flags␊
      debug: true␊
      repositoryRoot: packages/build/tests/log/fixtures/truncate_headers␊
      testOpts:␊
        pluginsListUrl: test␊
        silentLingeringProcesses: true␊
      verbose: true␊
    ␊
    > Current directory␊
      packages/build/tests/log/fixtures/truncate_headers␊
    ␊
    > Config file␊
      packages/build/tests/log/fixtures/truncate_headers/netlify.toml␊
    ␊
    > Resolved config␊
      build:␊
        publish: packages/build/tests/log/fixtures/truncate_headers␊
        publishOrigin: default␊
      plugins:␊
        - inputs: {}␊
          origin: config␊
    ...
    Netlify configuration property "headers" value changed to [␊
      { for: '/external/path', values: { TEST: 'test' } },␊
      { for: '/external/path', values: { TEST: 'test' } },␊
      { for: '/external/path', values: { TEST: 'test' } },␊
      { for: '/external/path', values: { TEST: 'test' } },␊
      { for: '/external/path', values: { TEST: 'test' } },␊
    ...
    ␊
      Error location␊
      In "onPostBuild" event in "./plugin" from netlify.toml␊
    STACK TRACE␊
    ␊
      Resolved config␊
      build:␊
...
> Snapshot 1
    ...
    > Flags␊
      debug: true␊
      repositoryRoot: packages/build/tests/log/fixtures/truncate_redirects␊
      testOpts:␊
        pluginsListUrl: test␊
        silentLingeringProcesses: true␊
      verbose: true␊
    ␊
    > Current directory␊
      packages/build/tests/log/fixtures/truncate_redirects␊
    ␊
    > Config file␊
      packages/build/tests/log/fixtures/truncate_redirects/netlify.toml␊
    ␊
    > Resolved config␊
      build:␊
        publish: packages/build/tests/log/fixtures/truncate_redirects␊
        publishOrigin: default␊
      plugins:␊
        - inputs: {}␊
          origin: config␊
