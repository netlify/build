...
> Snapshot 1
    ...
    ␊
      ...
      /file/path error: Could not resolve "math-avg" (mark it as external to exclude it from the bundle)␊
    ␊
      Resolved config␊
      build:␊
        functions: /file/path`
...
> Snapshot 1
    ...
    ␊
      ...
      /file/path error: Could not resolve "math-avg" (mark it as external to exclude it from the bundle)␊
      /file/path error: Could not resolve "sharp" (mark it as external to exclude it from the bundle)␊
    ␊
      Resolved config␊
      build:␊
        functions: /file/path`
