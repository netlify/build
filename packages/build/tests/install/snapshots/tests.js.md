...
> Snapshot 1
    ...
    ␊
      Error message␊
      Error while installing dependencies in packages/build/tests/install/fixtures/functions_yarn/functions␊
...
> Snapshot 1
    ...
    ␊
      Error message␊
      Error while installing dependencies in packages/build/tests/install/fixtures/functions_yarn_ci/functions␊
      Unknown Syntax Error: Unsupported option name ("--no-progress").␊
    ␊
      $ yarn install [--json] [--immutable] [--immutable-cache] [--check-cache] [--inline-builds] [--mode #0]␊
    ␊
...
> Snapshot 1
    ...
    ␊
      Error message␊
      Error while installing dependencies in packages/build/tests/install/fixtures/yarn/plugin␊
      Unknown Syntax Error: Unsupported option name ("--no-progress").␊
    ␊
      $ yarn install [--json] [--immutable] [--immutable-cache] [--check-cache] [--inline-builds] [--mode #0]␊
    ␊
...
> Snapshot 1
    ...
    ␊
      Error message␊
      Error while installing dependencies in packages/build/tests/install/fixtures/yarn_ci/plugin␊
      Unknown Syntax Error: Unsupported option name ("--no-progress").␊
    ␊
      $ yarn install [--json] [--immutable] [--immutable-cache] [--check-cache] [--inline-builds] [--mode #0]␊
    ␊
