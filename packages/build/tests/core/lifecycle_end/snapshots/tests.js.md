...
> Snapshot 1
    ...
    ␊
    ┌──────────────────────────────────────────────────────────────────┐␊
    │ 2. build.lifecycle.onError command from netlify.toml config file │␊
    └──────────────────────────────────────────────────────────────────┘␊
    ␊
    $ echo onEnd␊
    onEnd␊
    ...
    ␊
    ┌────────────────────────────────────────────────────────────────┐␊
    │ 3. build.lifecycle.onEnd command from netlify.toml config file │␊
    └────────────────────────────────────────────────────────────────┘␊
    ␊
    $ echo onEnd␊
    onEnd␊
...
> Snapshot 1
    ...
    ␊
    ┌────────────────────────────────────────────────────────────────┐␊
    │ 2. build.lifecycle.onEnd command from netlify.toml config file │␊
    └────────────────────────────────────────────────────────────────┘␊
    ␊
    $ echo onEnd␊
    onEnd␊
...
> Snapshot 1
    ...
    ␊
    ┌────────────────────────────────────────────────────────────────────┐␊
    │ 2. build.lifecycle.onSuccess command from netlify.toml config file │␊
    └────────────────────────────────────────────────────────────────────┘␊
    ␊
    $ echo onSuccess␊
    onSuccess␊
