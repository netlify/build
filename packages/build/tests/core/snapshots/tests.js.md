...
> Snapshot 1
    ...
    ␊
      ...
      packages/build/tests/core/fixtures/functions_config_3/functions/function_two.js error: Could not resolve "@netlify/imaginary-module-two" (mark it as external to exclude it from the bundle, or surround it with try/catch to handle the failure at run-time)␊
    ␊
      Resolved config␊
      functions:␊
        '*':␊
...
> Snapshot 1
    ...
    > Resolved config␊
      functions:␊
        '*':␊
          node_bundler: esbuild␊
      functionsDirectory: packages/build/tests/core/fixtures/esbuild_errors/functions␊
    ␊
    > Context␊
      production␊
    ␊
