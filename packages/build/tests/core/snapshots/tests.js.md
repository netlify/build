...
## --node-path is used by local plugins if the feature flag plugins_system_node_version is set to false
...
> Snapshot 1
    ...
    > Resolved config␊
      build:␊
        publish: packages/build/tests/core/fixtures/local_node_path␊
        publishOrigin: default␊
      plugins:␊
        - inputs: {}␊
          origin: config␊
...
## --node-path is used by plugins added to package.json if the feature flag plugins_system_node_version is set to false
...
> Snapshot 1
    ...
    > Resolved config␊
      build:␊
        publish: packages/build/tests/core/fixtures/package␊
        publishOrigin: default␊
      plugins:␊
        - inputs: {}␊
          origin: config␊
...
## Does not require the `.netlify/functions-internal` or the main functions directory to exist
...
> Snapshot 1
    ...
    > Flags␊
      ...
      featureFlags:␊
        - buildbot_build_plugins_system_node_version␊
      repositoryRoot: packages/build/tests/core/fixtures/functions_internal_main_missing␊
      testOpts:␊
        pluginsListUrl: test␊
        silentLingeringProcesses: true␊
    ␊
    > Current directory␊
      packages/build/tests/core/fixtures/functions_internal_main_missing␊
    ␊
    > Config file␊
      No config file was defined: using default values.␊
    ␊
    > Resolved config␊
      build:␊
        publish: packages/build/tests/core/fixtures/functions_internal_main_missing␊
        publishOrigin: default␊
    ␊
    > Context␊
      production␊
