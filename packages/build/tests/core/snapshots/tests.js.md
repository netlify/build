...
> Snapshot 1
    ...
    ␊
      ...
      packages/build/tests/core/fixtures/functions_config_3/functions/function_two.js error: Could not resolve "@netlify/imaginary-module-two" (mark it as external to exclude it from the bundle)␊
    ␊
      Resolved config␊
      build:␊
        functions: packages/build/tests/core/fixtures/functions_config_3/functions`
