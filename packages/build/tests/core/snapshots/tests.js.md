...
## Does not generate a `manifest.json` file when running in buildbot
...
> Snapshot 1
    ...
    > Flags␊
      debug: true␊
      mode: buildbot␊
      repositoryRoot: packages/build/tests/core/fixtures/functions_internal_no_manifest_1␊
      testOpts:␊
        pluginsListUrl: test␊
        silentLingeringProcesses: true␊
    ␊
    > Current directory␊
      packages/build/tests/core/fixtures/functions_internal_no_manifest_1␊
    ␊
    > Config file␊
      No config file was defined: using default values.␊
    ␊
    > Resolved config␊
      build:␊
        publish: packages/build/tests/core/fixtures/functions_internal_no_manifest_1␊
        publishOrigin: default␊
      functionsDirectory: packages/build/tests/core/fixtures/functions_internal_no_manifest_1/netlify/functions␊
    ␊
    > Context␊
      production␊
    ␊
...
## Does not generate a `manifest.json` file when the feature flag is not enabled
...
> Snapshot 1
    ...
    > Flags␊
      debug: true␊
      mode: buildbot␊
      repositoryRoot: packages/build/tests/core/fixtures/functions_internal_no_manifest_2␊
      testOpts:␊
        pluginsListUrl: test␊
        silentLingeringProcesses: true␊
    ␊
    > Current directory␊
      packages/build/tests/core/fixtures/functions_internal_no_manifest_2␊
    ␊
    > Config file␊
      No config file was defined: using default values.␊
    ␊
    > Resolved config␊
      build:␊
        publish: packages/build/tests/core/fixtures/functions_internal_no_manifest_2␊
        publishOrigin: default␊
      functionsDirectory: packages/build/tests/core/fixtures/functions_internal_no_manifest_2/netlify/functions␊
    ␊
    > Context␊
      production␊
    ␊
