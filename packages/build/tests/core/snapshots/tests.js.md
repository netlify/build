...
## Functions schedule is parsed (1)
...
> Snapshot 1
    ...
    > Flags␊
      debug: true␊
      repositoryRoot: packages/build/tests/core/fixtures/functions_schedule_1␊
      testOpts:␊
        pluginsListUrl: test␊
        silentLingeringProcesses: true␊
    ␊
    > Current directory␊
      packages/build/tests/core/fixtures/functions_schedule_1␊
    ␊
    > Config file␊
      packages/build/tests/core/fixtures/functions_schedule_1/netlify.toml␊
    ␊
    > Resolved config␊
      build:␊
        publish: packages/build/tests/core/fixtures/functions_schedule_1␊
        publishOrigin: default␊
      functions:␊
        foo:␊
          schedule: '@daily'␊
...
## Functions schedule is parsed (2)
...
> Snapshot 1
    ...
    > Flags␊
      debug: true␊
      repositoryRoot: packages/build/tests/core/fixtures/functions_schedule_2␊
      testOpts:␊
        pluginsListUrl: test␊
        silentLingeringProcesses: true␊
    ␊
    ...
    ␊
      Error message␊
      When resolving config file packages/build/tests/core/fixtures/functions_schedule_2/netlify.toml:␊
      Configuration property functions.foo.schedule must be valid cron syntax.␊
    ␊
      Invalid syntax␊
    ␊
        [functions]␊
...
## Functions schedule is parsed (3)
...
> Snapshot 1
    ...
    > Flags␊
      debug: true␊
      repositoryRoot: packages/build/tests/core/fixtures/functions_schedule_3␊
      testOpts:␊
        pluginsListUrl: test␊
        silentLingeringProcesses: true␊
    ␊
    > Current directory␊
      packages/build/tests/core/fixtures/functions_schedule_3␊
    ␊
    > Config file␊
      packages/build/tests/core/fixtures/functions_schedule_3/netlify.toml␊
    ␊
    > Resolved config␊
      build:␊
        publish: packages/build/tests/core/fixtures/functions_schedule_3␊
        publishOrigin: default␊
      functions:␊
        foo:␊
          schedule: '* * * L * *'␊
