...
> Snapshot 1
    ...
    `{␊
      configPath: 'packages/build/tests/core/fixtures/empty/netlify.toml',␊
      repositoryRoot: 'packages/build/tests/core/fixtures/empty',␊
...
> Snapshot 1
    ...
    `{␊
      configPath: 'packages/build/tests/core/fixtures/single/netlify.toml',␊
      repositoryRoot: 'packages/build/tests/core/fixtures/single',␊
      configBase: undefined,␊
      packagePath: undefined␊
    }␊
...
> Snapshot 1
    ...
    ␊
      [functions]␊
        external_node_modules = ["test", "test_2", "@org/yet-another-test"]␊
    ␊
