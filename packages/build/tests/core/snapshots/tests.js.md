...
> Snapshot 1
    ...
    Options:␊
      ...
      --cwd               Current directory. Used to retrieve the configuration␊
                          file.␊
      ...
      --nodePath          Path to the Node.js binary to use in user commands and␊
                          build plugins.␊
                          Default: Current Node.js binary                   [string]␊
      --functionsDistDir  Path to the directory where packaged functions are kept.␊
                          Default: automatically guessed                    [string]␊
