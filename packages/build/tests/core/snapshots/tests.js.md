...
> Snapshot 1
    ...
    > Resolved config␊
      build:␊
        command: echo test␊
        commandOrigin: config␊
        functions: packages/build/tests/core/fixtures/several/functions␊
      plugins:␊
        - inputs: {}␊
          origin: config␊
          package: plugin␊
...
> Snapshot 1
    ...
    > Resolved config␊
      build:␊
        functions: packages/build/tests/core/fixtures/core/functions␊
    ␊
    > Context␊
      production␊
    ␊
...
> Snapshot 1
    ...
    > Resolved config␊
      build:␊
        functions: packages/build/tests/core/fixtures/functions_config_1/functions␊
    ␊
    > Context␊
      production␊
    ␊
...
> Snapshot 1
    ...
    > Resolved config␊
      build:␊
        functions: packages/build/tests/core/fixtures/functions_config_2/functions␊
    ␊
    > Context␊
      production␊
    ␊
...
> Snapshot 1
    ...
    > Resolved config␊
      build:␊
        functions: packages/build/tests/core/fixtures/functions_config_3/functions␊
    ␊
    > Context␊
      production␊
    ␊
    ...
    ␊
      ...
      /file/path/function_two.js:4:80: error: Could not resolve "@netlify/imaginary-module-two" (mark it as external to exclude it from the bundle)␊
    ␊
      Resolved config␊
      build:␊
        functions: packages/build/tests/core/fixtures/functions_config_3/functions`
...
> Snapshot 1
    ...
    > Flags␊
      debug: true␊
      featureFlags: {}␊
      repositoryRoot: packages/build/tests/core/fixtures/esbuild_errors␊
      testOpts:␊
        pluginsListUrl: test␊
        silentLingeringProcesses: true␊
    ␊
    > Current directory␊
      packages/build/tests/core/fixtures/esbuild_errors␊
    ␊
    > Config file␊
      packages/build/tests/core/fixtures/esbuild_errors/netlify.toml␊
    ␊
    > Resolved config␊
      build:␊
        functions: packages/build/tests/core/fixtures/esbuild_errors/functions␊
    ␊
    > Context␊
      production␊
    ␊
