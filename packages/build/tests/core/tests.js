...
test.serial('Passes functions generated by build plugins to zip-it-and-ship-it', async (t) => {
  ...
  console.log('-> Function paths', functionPaths)

  t.true(functionPaths.includes('.netlify/functions-internal'))
  t.true(functionPaths.includes('.netlify/v1/functions'))
  t.true(functionPaths.includes('netlify/functions'))
  t.true(functionPaths.includes('.netlify/plugins/node_modules/plugin/functions/plugin-func1.mjs'))
})
