...
> Snapshot 1
    ...
    ────────────────────────────────────────────────────────────────␊
    ␊
    Writing deploy metadata to packages/build/tests/functions/fixtures/missing/.netlify/deploy-metadata.json...␊
    Wrote deploy metadata to packages/build/tests/functions/fixtures/missing/.netlify/deploy-metadata.json.␊
    ␊
...
> Snapshot 1
    ...
    ────────────────────────────────────────────────────────────────␊
    ␊
    Writing deploy metadata to packages/build/tests/functions/fixtures/symlink/.netlify/deploy-metadata.json...␊
    Wrote deploy metadata to packages/build/tests/functions/fixtures/symlink/.netlify/deploy-metadata.json.␊
    ␊
    (Deploy metadata completed in 1ms)␊
    Build step duration: Deploy metadata completed in 1ms␊
    ␊
...
> Snapshot 1
    ...
    ────────────────────────────────────────────────────────────────␊
    ␊
    Writing deploy metadata to packages/build/tests/functions/fixtures/default/.netlify/deploy-metadata.json...␊
    Wrote deploy metadata to packages/build/tests/functions/fixtures/default/.netlify/deploy-metadata.json.␊
    ␊
    (Deploy metadata completed in 1ms)␊
    Build step duration: Deploy metadata completed in 1ms␊
    ␊
...
> Snapshot 1
    ...
    ────────────────────────────────────────────────────────────────␊
    ␊
    Writing deploy metadata to packages/build/tests/functions/fixtures/simple/.netlify/deploy-metadata.json...␊
    Wrote deploy metadata to packages/build/tests/functions/fixtures/simple/.netlify/deploy-metadata.json.␊
    ␊
    (Deploy metadata completed in 1ms)␊
    Build step duration: Deploy metadata completed in 1ms␊
    ␊
...
> Snapshot 1
    ...
    ────────────────────────────────────────────────────────────────␊
    ␊
    Writing deploy metadata to packages/build/tests/functions/fixtures/none/.netlify/deploy-metadata.json...␊
    Wrote deploy metadata to packages/build/tests/functions/fixtures/none/.netlify/deploy-metadata.json.␊
    ␊
    (Deploy metadata completed in 1ms)␊
    Build step duration: Deploy metadata completed in 1ms␊
    ␊
