...
> Snapshot 1
    ...
    ␊
    ␊
    > Secrets scanning found 32 instance(s) of secrets in build output or repo code.␊
    ␊
    ...
    Secret env var "ENV_VAR_2"'s value detected:␊
      found value at line 1 in dist/static-a.txt␊
    ...
    Secret env var "ENV_VAR_MULTILINE_A"'s value detected:␊
      found value at line 16 in dist/static-files/static-c.txt␊
      found value at line 37 in dist/static-files/static-c.txt␊
      found value at line 1 in dist/static-files/static-d.txt␊
      found value at line 15 in netlify.toml␊
      found value at line 16 in src/static-files/static-c.txt␊
      found value at line 37 in src/static-files/static-c.txt␊
...
> Snapshot 1
    ...
    ────────────────────────────────────────────────────────────────␊
    ␊
    Secrets scanning complete. No secrets detected in build output or repo code.␊
    ␊
    (Secrets scanning completed in 1ms)␊
    ␊
    Netlify Build Complete                                        ␊
