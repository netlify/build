...
## secrets scanning, should skip when secrets passed but no non-empty env vars set
...
> Snapshot 1
    ...
    ␊
    ␊
    > Secrets scanning found 13 instance(s) of secrets in build output or repo code.␊
    ␊
