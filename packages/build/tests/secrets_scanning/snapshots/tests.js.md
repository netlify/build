...
> Snapshot 1
    ...
    ␊
    ␊
    > Scanning complete. 7 file(s) scanned. Secrets scanning found 3 instance(s) of secrets in build output or repo code.␊
    ␊
    Secret env var "ENV_VAR_2"'s value detected:␊
      found value at line 1 in dist/notsafefile.js␊
