...
> Snapshot 1
    ...
    ␊
    > Error message␊
      Wrong permissions on the base directory /␊
    ␊
    ┌─────────────────────────────┐␊
...
> Snapshot 1
    ...
    > Error message␊
      ...
      Cannot find module 'invalid' from '/file/path'␊
    ␊
    ┌─────────────────────────────┐␊
    │   END Configuration error   │␊
    └─────────────────────────────┘␊
...
> Snapshot 1
    ...
    ␊
    > Error message␊
      Configuration file does not exist: @netlify/invalid␊
      Cannot find module '@netlify/invalid' from '/file/path'␊
    ␊
    ┌─────────────────────────────┐␊
    │   END Configuration error   │␊
    └─────────────────────────────┘␊
