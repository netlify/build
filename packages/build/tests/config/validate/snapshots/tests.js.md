...
> Snapshot 1
    ...
    ␊
      Invalid syntax␊
    ␊
        context: development: base: true␊
    ␊
      Valid syntax␊
    ␊
        context: development: base: packages/project␊
    ␊
    ┌─────────────────────────────┐␊
    │   END Configuration error   │␊
    └─────────────────────────────┘␊
...
> Snapshot 1
    ...
    ␊
      Valid syntax␊
    ␊
        context: production: publish: dist␊
    ␊
    ┌─────────────────────────────┐␊
    │   END Configuration error   │␊
    └─────────────────────────────┘␊
...
> Snapshot 1
    ...
    ␊
      Invalid syntax␊
    ␊
        context: development: lifecycle: onBuild: true␊
    ␊
      Valid syntax␊
    ␊
        context: development: lifecycle: onBuild:␊
                - npm run build␊
                - npm test␊
    ␊
    ┌─────────────────────────────┐␊
