...
> Snapshot 1
    ...
    ␊
      - true␊
    ␊
    Example 'netlify.yml': build: command:␊
          - npm run build␊
          - npm test␊
    `
...
> Snapshot 1
    ...
    Invalid value: test␊
    ␊
    Example 'netlify.yml': build: lifecycle: build: npm run build␊
    `
...
> Snapshot 1
    ...
    Invalid value: true␊
    ␊
    Example 'netlify.yml': build: functions: functions␊
    `
...
> Snapshot 1
    ...
    ␊
      - true␊
    ␊
    Example 'netlify.yml': build: lifecycle: build:␊
            - npm run build␊
            - npm test␊
    `
...
> Snapshot 1
    ...
    Invalid value: true␊
    ␊
    Example 'netlify.yml': build: publish: dist␊
    `
