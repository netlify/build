# Snapshot report for `tests/steps/tests.js`
...
> Snapshot 1
    ...
    ────────────────────────────────────────────────────────────────␊
    ␊
    Writing deploy metadata to packages/build/tests/steps/fixtures/bash/.netlify/deploy-metadata.json...␊
    Wrote deploy metadata to packages/build/tests/steps/fixtures/bash/.netlify/deploy-metadata.json.␊
    ␊
...
> Snapshot 1
    ...
    ────────────────────────────────────────────────────────────────␊
    ␊
    Writing deploy metadata to packages/build/tests/steps/fixtures/shell/.netlify/deploy-metadata.json...␊
    Wrote deploy metadata to packages/build/tests/steps/fixtures/shell/.netlify/deploy-metadata.json.␊
    ␊
    (Deploy metadata completed in 1ms)␊
    Build step duration: Deploy metadata completed in 1ms␊
    ␊
...
> Snapshot 1
    ...
    ────────────────────────────────────────────────────────────────␊
    ␊
    Writing deploy metadata to packages/build/tests/steps/fixtures/global_bin/.netlify/deploy-metadata.json...␊
    Wrote deploy metadata to packages/build/tests/steps/fixtures/global_bin/.netlify/deploy-metadata.json.␊
    ␊
    (Deploy metadata completed in 1ms)␊
    Build step duration: Deploy metadata completed in 1ms␊
    ␊
...
> Snapshot 1
    ...
    ────────────────────────────────────────────────────────────────␊
    ␊
    Writing deploy metadata to packages/build/tests/steps/fixtures/local_bin/.netlify/deploy-metadata.json...␊
    Wrote deploy metadata to packages/build/tests/steps/fixtures/local_bin/.netlify/deploy-metadata.json.␊
    ␊
    (Deploy metadata completed in 1ms)␊
    Build step duration: Deploy metadata completed in 1ms␊
    ␊
...
> Snapshot 1
    ...
    ────────────────────────────────────────────────────────────────␊
    ␊
    Writing deploy metadata to packages/build/tests/steps/fixtures/pwd/.netlify/deploy-metadata.json...␊
    Wrote deploy metadata to packages/build/tests/steps/fixtures/pwd/.netlify/deploy-metadata.json.␊
    ␊
    (Deploy metadata completed in 1ms)␊
    Build step duration: Deploy metadata completed in 1ms␊
    ␊
...
> Snapshot 1
    ...
    ────────────────────────────────────────────────────────────────␊
    ␊
    Writing deploy metadata to packages/build/tests/steps/fixtures/none/.netlify/deploy-metadata.json...␊
    Wrote deploy metadata to packages/build/tests/steps/fixtures/none/.netlify/deploy-metadata.json.␊
    ␊
    (Deploy metadata completed in 1ms)␊
    Build step duration: Deploy metadata completed in 1ms␊
    ␊
...
> Snapshot 1
    ...
    ────────────────────────────────────────────────────────────────␊
    ␊
    Writing deploy metadata to packages/build/tests/steps/fixtures/invalid_package_json/.netlify/deploy-metadata.json...␊
    Wrote deploy metadata to packages/build/tests/steps/fixtures/invalid_package_json/.netlify/deploy-metadata.json.␊
    ␊
    (Deploy metadata completed in 1ms)␊
    Build step duration: Deploy metadata completed in 1ms␊
    ␊
