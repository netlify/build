...
> Snapshot 1
    ...
    ␊
      Error message␊
      When resolving config file /file/path/invalid:␊
...
> Snapshot 1
    ...
    {␊
      ...
      "groupingHash": "API error on /"cancelSiteDeploy/"/file/path/nUnauthorized",␊
      "severity": "error",␊
      "unhandled": true,␊
      "location": {␊
...
> Snapshot 1
    ...
    {␊
      ...
      "groupingHash": "Configuration error/nWhen resolving config file /file/path/nConfiguration property build must be a plain object./n/nInvalid syntax/n/n  build = false/n/nValid syntax/n/n  [build]/n  command = /"npm run build/"",␊
      "severity": "info",␊
      "unhandled": false,␊
      "pluginPackageJson": false,␊
      "other": {␊
...
> Snapshot 1
    ...
    > Resolved config␊
      build:␊
        functions: packages/build/tests/error/fixtures/dependencies/functions␊
    ␊
    > Context␊
      production␊
    ␊
...
> Snapshot 1
    ...
    {␊
      ...
      "errorMessage": "Plugin /"plugin.js" does not accept any inputs but you specified: /"test/"/file/path/nCheck your plugin configuration to be sure that:/n  - the input name is spelled correctly/n  - the input is included in the plugin's available configuration options/n  - the plugin's input requirements have not changed/n/nPlugin inputs/ntest: true",␊
      "context": "Plugin /"plugin.js" invalid input /"test/"",␊
      "groupingHash": "Plugin /"plugin.js" invalid input /"test/"/file/path/nPlugin /"/file/path/path" does not accept any inputs but you specified: /file/path/nCheck your plugin configuration to be sure that:/n  - the input name is spelled correctly/n  - the input is included in the plugin's available configuration options/n  - the plugin's input requirements have not changed/n",␊
      "severity": "info",␊
      "unhandled": false,␊
      "location": {␊
        "event": "load",␊
