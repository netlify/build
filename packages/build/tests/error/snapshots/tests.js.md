...
> Snapshot 1
    ...
    > Flags␊
      debug: true␊
      repositoryRoot: packages/build/tests/error/fixtures/typescript␊
      testOpts:␊
        errorMonitor: true␊
        pluginsListUrl: test␊
        silentLingeringProcesses: true␊
    ␊
    > Current directory␊
      packages/build/tests/error/fixtures/typescript␊
    ␊
    > Config file␊
      packages/build/tests/error/fixtures/typescript/netlify.toml␊
    ␊
    > Resolved config␊
      build:␊
        publish: packages/build/tests/error/fixtures/typescript␊
        publishOrigin: default␊
      plugins:␊
        - inputs: {}␊
          origin: config␊
    ...
    ␊
      Error message␊
      TSError: Could not import plugin:␊
      ⨯ Unable to compile TypeScript:␊
      plugin.ts(4,25): error TS2339: Property 'DOES_NOT_EXIST' does not exist on type 'NetlifyPluginConstants'.␊
    ␊
      ...
      compilerOptions:␊
        ...
        types:␊
          - node␊
      ts-node:␊
        cwd: packages/build/tests/error/fixtures/typescript␊
        projectSearchDir: packages/build/tests/error/fixtures/typescript␊
        require: []␊
    ␊
      Plugin details␊
      Package:        ./plugin.ts␊
    ...
    ␊
      Error properties␊
      {␊
        diagnosticText: "plugin.ts(4,25): error TS2339: Property 'DOES_NOT_EXIST' does not exist on type 'NetlifyPluginConstants'./n",␊
    ...
    {␊
      "errorClass": "pluginInternal",␊
      "errorMessage": "Could not import plugin:/n⨯ Unable to compile TypeScript:/nplugin.ts(4,25): error TS2339: Property 'DOES_NOT_EXIST' does not exist on type 'NetlifyPluginConstants'./n",␊
      "context": "Plugin /"./plugin.ts/" internal error",␊
      "groupingHash": "Plugin /"./plugin.ts/" internal error/nCould not import plugin:/n⨯ Unable to compile TypeScript:/nplugin.ts(0,0): error TS0: Property 'DOES_NOT_EXIST' does not exist on type 'NetlifyPluginConstants'./n",␊
      "severity": "info",␊
      "unhandled": false,␊
      "location": {␊
        "event": "load",␊
