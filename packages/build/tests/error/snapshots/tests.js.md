...
> Snapshot 1
    ...
    {␊
      ...
      "errorMessage": "A Netlify Function failed to require one of its dependencies./nPlease make sure it is present in the site's top-level /"package.json/"/file/path file /"/file/path"/file/path find module 'does-not-exist'/file/path stack:/n- /file/path",␊
