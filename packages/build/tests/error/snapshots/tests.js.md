...
> Snapshot 1
    ...
    ␊
      ...
      compilerOptions:␊
        ...
        paths:␊
          '@netlify/build':␊
            - packages/build/types/index.d.ts␊
        skipLibCheck: true␊
        sourceMap: true␊
        strict: true␊
        target: es2000␊
    ...
    {␊
      "errorClass": "pluginInternal",␊
      "errorMessage": "⨯ Unable to compile TypeScript:/nplugin.ts(4,25): error TS2339: Property 'DOES_NOT_EXIST' does not exist on type 'NetlifyPluginConstants'./n",␊
      "context": "Plugin /"./plugin.ts/" internal error",␊
      "groupingHash": "Plugin /"./plugin.ts/" internal error/n⨯ Unable to compile TypeScript:/nplugin.ts(0,0): error TS0: Property 'DOES_NOT_EXIST' does not exist on type 'NetlifyPluginConstants'./n",␊
      "severity": "info",␊
      "unhandled": false,␊
      "location": {␊
        "event": "load",␊
