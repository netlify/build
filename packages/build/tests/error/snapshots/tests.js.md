...
> Snapshot 1
    ...
    {␊
      ...
      "errorMessage": "A Netlify Function failed to require one of its dependencies./nIf the dependency is a Node module, please make sure it is present in the site's top-level /"package.json/"/file/path it is a local file instead, please make sure the file exists and its filename is correctly spelled./n/nIn file /"/file/path"/file/path find module 'does-not-exist'/file/path stack:/n- /file/path",␊
