...
## Prints a warning when build command fails in CI with create-react-app
...
> Snapshot 1
    ...
    $ node index.js␊
    ␊
      If the build failed with a warning about "process.env1.0.0CI = true", this is due to "create-react-app" treating warnings as errors when in CI. In order to fix this problem, please either:␊
