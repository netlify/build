...
> Snapshot 1
    ...
    `❯ Starting Netlify Build version 0.0.26␊
...
> Snapshot 1
    ...
    │    Netlify Build Error!     │␊
    └─────────────────────────────┘␊
     Error in '@netlify/plugin-functions-core' plugin:␊
    Command failed with exit code 1␊
    Error: Functions directory "/file/path" not found␊
    STACK TRACE␊
    ␊
...
## Validate plugin.name is a valid name
...
> Snapshot 1
    ...
    ❯ Loading plugins␊
      Loading plugin "@netlify/plugin-functions-core" from build core␊
      Loading plugin from /file/path␊
    Error: Missing required property 'name' in /file/path␊
    ␊
    ...
    ␊
    ␊
    Example: function netlifyPlugin(config) { return { name: 'my-plugin-name', <--- New required "name" field␊
        init: () => { console.log('Hi from init')␊
        }, } }␊
    ␊
    STACK TRACE␊
    ┌─────────────────────────────┐␊
