...
## Can extend and override plugins
...
> Snapshot 1
    ...
    ␊
    ┌──────────────────────────────────────┐␊
    │ 1. Running init lifecycle from two   │␊
    └──────────────────────────────────────┘␊
    ␊
    two␊
    ␊
    ...
    ␊
    ┌──────────────────────────────────────┐␊
    │ 2. Running init lifecycle from one   │␊
    └──────────────────────────────────────┘␊
    ␊
    one␊
    ␊
...
> Snapshot 1
    ...
    └────────────────────────────────────────────────────────────────────────────────────┘␊
    ␊
    Running command "echo two"␊
    two␊
    Running command "echo one"␊
    one␊
    ␊
     √  build.lifecycle.build completed in 1ms␊
    ␊
...
## Can extend with an empty array
...
> Snapshot 1
    ...
    ␊
    Error in "build" step from "node --invalid"␊
