...
## The build main process can still fail when the telemetry process is not awaited
...
## The build main process can still succeed when the telemetry process is not awaited
