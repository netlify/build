...
> Snapshot 1
    ...
    ────────────────────────────────────────────────────────────────␊
    ␊
    Writing deploy metadata to packages/build/tests/telemetry/fixtures/success/.netlify/deploy-metadata.json...␊
    Wrote deploy metadata to packages/build/tests/telemetry/fixtures/success/.netlify/deploy-metadata.json.␊
    ␊
