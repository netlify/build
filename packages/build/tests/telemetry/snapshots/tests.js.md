...
> Snapshot 1
    ...
    > Flags␊
      ...
      testOpts:␊
        ...
        telemetryUnrefChildProcess: false␊
    ␊
    > Current directory␊
      /file/path␊
    ␊
...
## Telemetry's unref'd child process does not disturb regular build process execution on error
...
## Telemetry's unref'd child process does not disturb regular build process execution on success
