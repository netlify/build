...
## Throws an error if the deploy configuration file is malformed
...
> Snapshot 1
    ...
    > Flags␊
      debug: true␊
      repositoryRoot: packages/build/tests/deploy_config/fixtures/malformed_config␊
      testOpts:␊
        pluginsListUrl: test␊
        silentLingeringProcesses: true␊
    ␊
    > Current directory␊
      packages/build/tests/deploy_config/fixtures/malformed_config␊
    ␊
    > Config file␊
    ...
    > Resolved config␊
      build:␊
        command: echo Hello␊
        commandOrigin: config␊
        publish: packages/build/tests/deploy_config/fixtures/malformed_config␊
        publishOrigin: default␊
      plugins:␊
        - inputs: {}␊
          origin: config␊
    ...
    (./plugin.js onPreBuild completed in 1ms)␊
    Build step duration: ./plugin.js onPreBuild completed in 1ms␊
    Failed to read Deploy Configuration API: SyntaxError: Unexpected token o in JSON at position 1␊
    ␊
    Internal error during "Applying Deploy Configuration"         ␊
    ────────────────────────────────────────────────────────────────␊
    ␊
      Error message␊
    ...
    ␊
      Error location␊
      During Applying Deploy Configuration␊
    STACK TRACE␊
    ␊
      Resolved config␊
      build:␊
