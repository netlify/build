...
> Snapshot 1
    ...
    > Context␊
      production␊
    ␊
    > Warning: Starting January 16, 2024 plugin "./plugin.js" will be executed with Node.js version 20.␊
      We're upgrading our system node version on that day, which means the plugin cannot be executed with your defined Node.js version 1.0.0.␊
    ␊
      Please make sure your plugin supports being run on Node.js 20.␊
    ␊
      Read more about our minimum required version in our forums announcement (https://answers.netlify.com/t/build-plugin-update-system-node-js-version-upgrade-to-20/108633)␊
    ␊
    Configuration error                                           ␊
    ────────────────────────────────────────────────────────────────␊
    ␊
