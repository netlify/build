...
> Snapshot 1
    ...
    > Flags␊
      debug: true␊
      featureFlags:␊
        new_plugins_install: true␊
      repositoryRoot: /file/path␊
      testOpts:␊
        pluginsListUrl: 'http://localhost:80'␊
...
> Snapshot 1
    ...
    ␊
    > Installing plugins␊
       - power-cartesian-product@latest␊
    ␊
    > Missing plugins␊
    ...
    ␊
      Error message␊
      The plugin "power-cartesian-product" is missing a "manifest.yml".␊
      This might mean:␊
