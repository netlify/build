...
> Snapshot 1
    ...
    ␊
    > Config file␊
      packages/build/tests/plugins/fixtures/pin_success/netlify.toml␊
    ␊
    > Resolved config␊
      plugins:␊
        - inputs: {}␊
    ...
    ␊
    > Loading plugins␊
       - netlify-plugin-contextual-env 0-3-0 from netlify.toml (pinned 1, latest 1.0.0, expected 1.0.0, compatible 1.0.0)␊
    ␊
    ────────────────────────────────────────────────────────────────␊
      1. onPreBuild command from netlify-plugin-contextual-env      ␊
    ────────────────────────────────────────────────────────────────␊
