...
> Snapshot 1
    ...
    ␊
    > Loading plugins␊
       - netlify-plugin-contextual-env 0-3-0 from netlify.toml (latest 1.0.0, expected 1.0.0, compatible 1.0.0)␊
    ␊
    ────────────────────────────────────────────────────────────────␊
...
> Snapshot 1
    ...
    ␊
    > Loading plugins␊
       - netlify-plugin-contextual-env 0-3-0 from Netlify app (pinned 1, latest 1.0.0, expected 1.0.0, compatible 1.0.0)␊
    ␊
    ────────────────────────────────────────────────────────────────␊
      1. onPreBuild command from netlify-plugin-contextual-env      ␊
    ────────────────────────────────────────────────────────────────␊
...
> Snapshot 1
    ...
    ␊
    > Config file␊
      packages/build/tests/plugins/fixtures/pin_plugin_failed/netlify.toml␊
    ␊
    > Resolved config␊
      plugins:␊
        - inputs: {}␊
    ...
    ␊
      Error location␊
      In "onPreBuild" event in "netlify-plugin-contextual-env" from netlify.toml␊
    STACK TRACE␊
    ␊
      Resolved config␊
      plugins:␊
...
> Snapshot 1
    ...
    ␊
    > Loading plugins␊
       - netlify-plugin-contextual-env 0-3-0 from Netlify app (latest 1.0.0, expected 1.0.0, compatible 1.0.0)␊
    ␊
    ────────────────────────────────────────────────────────────────␊
      1. onPreBuild command from netlify-plugin-contextual-env      ␊
    ────────────────────────────────────────────────────────────────␊
...
> Snapshot 1
    ...
    ␊
    > Loading plugins␊
       - netlify-plugin-contextual-env 0-4-0 from netlify.toml and package.json (latest 1.0.0, expected 1.0.0, compatible 1.0.0)␊
    ␊
    ────────────────────────────────────────────────────────────────␊
      1. onPreBuild command from netlify-plugin-contextual-env      ␊
    ────────────────────────────────────────────────────────────────␊
...
> Snapshot 1
    ...
    ␊
    > Loading plugins␊
       - netlify-plugin-contextual-env 1-0-0 from netlify.toml and package.json (latest 1.0.0, expected 1.0.0, compatible 1.0.0)␊
    ␊
    ────────────────────────────────────────────────────────────────␊
      1. onPreBuild command from netlify-plugin-contextual-env      ␊
    ────────────────────────────────────────────────────────────────␊
...
> Snapshot 1
    ...
    ␊
    > Loading plugins␊
       - netlify-plugin-contextual-env 0-1-0 from netlify.toml (latest 1.0.0, expected 1.0.0, compatible 1.0.0)␊
    ␊
    > Outdated plugins␊
...
> Snapshot 1
    ...
    ␊
    > Loading plugins␊
       - netlify-plugin-contextual-env 0-2-0 from netlify.toml (latest 1.0.0, expected 1.0.0, compatible 1.0.0)␊
    ␊
    > Outdated plugins␊
...
> Snapshot 1
    ...
    ␊
    > Loading plugins␊
       - netlify-plugin-contextual-env 0-2-0 from netlify.toml and package.json (latest 1.0.0, expected 1.0.0, compatible 1.0.0)␊
    ␊
    > Outdated plugins␊
...
> Snapshot 1
    ...
    ␊
      Error properties␊
      { name: 'JSONHTTPError', status: 500, json: {} }␊
    ␊
      Resolved config␊
      plugins:␊
        - inputs: {}␊
