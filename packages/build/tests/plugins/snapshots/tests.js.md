...
## netlifyConfig.build.functions mutations fail
...
> Snapshot 1
    ...
    ␊
      Error message␊
      Error: "netlifyConfig.build.functions" is read-only. Please modify "netlifyConfig.functionsDirectory" instead.␊
    ␊
      Plugin details␊
      Package:        ./plugin␊
      Version:        1.0.0␊
...
## netlifyConfig.functions.directory mutations fail
...
> Snapshot 1
    ...
    ␊
      Error message␊
      Error: "netlifyConfig.functions.directory" is read-only. Please modify "netlifyConfig.functionsDirectory" instead.␊
    ␊
      Plugin details␊
      Package:        ./plugin␊
      Version:        1.0.0␊
...
## netlifyConfig.functions.star.directory mutations fail
