...
## Deploy plugin connection error
...
> Snapshot 1
    ...
    ␊
      Error message␊
      Could not connect to buildbot: Error: connect ENOENT /file/path␊
    ␊
      Plugin details␊
...
## Deploy plugin response payload error
...
## Deploy plugin response timeout
...
> Snapshot 1
    ...
    ␊
      Error message␊
      Could not connect to buildbot: Error: The TCP connection with the buildbot timed out after 1ms␊
    ␊
      Plugin details␊
      Package:        @netlify/plugin-deploy-core␊
      Version:        1.0.0␊
