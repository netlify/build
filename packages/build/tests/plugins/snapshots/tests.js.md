...
> Snapshot 1
    ...
    ␊
      Read more about our minimum required version in our forums announcement (https://answers.netlify.com/t/build-plugin-update-system-node-js-version-upgrade-to-20)␊
    ␊
    > Loading plugins␊
