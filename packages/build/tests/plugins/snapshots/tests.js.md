...
## No --node-path version validation is performed against the plugin engines if the plugins_system_node_version feature flag is set
...
## No --node-path version validation is performed if the plugins_system_node_version feature flag is set
...
## Provided --node-path version does not produce a node version warning if plugins were installed via the UI
...
## Provided --node-path version does not produce a node version warning if the build is being run locally
...
## Provided --node-path version has no effect for plugin executions when the feature flag plugins_system_node_version is set
...
## Provided --node-path version produces a node version warning if the build is being run in buildbot with local plugins and the plugins_system_node_version ff is set to false
...
> Snapshot 1
    ...
    > Context␊
      production␊
    Warning: please ensure the following Build Plugins are compatible with Node.js 1.0.0: ./plugin.js. These plugins currently run on Node.js 1.0.0. Due to upcoming changes, they will soon run on the build system's Node.js version (currently 1.0.0). For more info: http://ntl.fyi/build-plugins-node-versions␊
    ␊
    ────────────────────────────────────────────────────────────────␊
      Configuration error                                           ␊
    ────────────────────────────────────────────────────────────────␊
...
> Snapshot 1
    ...
    ────────────────────────────────────────────────────────────────␊
    ␊
    Netlify configuration property "functionsDirectory" value changed to 'test_functions'.␊
    ␊
    > Updated config␊
      build:␊
        publish: packages/build/tests/plugins/fixtures/config_mutate_general␊
...
## netlifyConfig array properties cannot be mutated per index
...
> Snapshot 1
    ...
    ␊
      Error message␊
      Error: Setting "netlifyConfig.functions.*.included_files.1" individual array element is not allowed.␊
...
## netlifyConfig array properties cannot be pushed
...
## netlifyConfig is updated when redirects file is created
...
> Snapshot 1
    ...
    > Flags␊
      ...
      featureFlags:␊
        - buildbot_build_plugins_system_node_version␊
      repositoryRoot: packages/build/tests/plugins/fixtures/config_create_redirects␊
      testOpts:␊
        pluginsListUrl: test␊
        silentLingeringProcesses: true␊
    ␊
    > Current directory␊
      packages/build/tests/plugins/fixtures/config_create_redirects␊
    ␊
    > Config file␊
      packages/build/tests/plugins/fixtures/config_create_redirects/netlify.toml␊
    ␊
    > Resolved config␊
      build:␊
        publish: packages/build/tests/plugins/fixtures/config_create_redirects␊
        publishOrigin: default␊
      functions:␊
        '*': {}␊
      plugins:␊
...
> Snapshot 1
    ...
    ────────────────────────────────────────────────────────────────␊
    ␊
    Netlify configuration property "Symbol(test)" value changed to true.␊
    ␊
    ────────────────────────────────────────────────────────────────␊
      Plugin "./plugin" internal error                              ␊
    ────────────────────────────────────────────────────────────────␊
    ␊
      Error message␊
      Error: "netlifyConfig.Symbol(test)" is read-only.␊
    ␊
      Plugin details␊
      Package:        ./plugin␊
      Version:        1.0.0␊
...
> Snapshot 1
    ...
    ────────────────────────────────────────────────────────────────␊
    ␊
    Netlify configuration property "plugins.0.inputs.example" value changed to true.␊
    ␊
    ────────────────────────────────────────────────────────────────␊
      Plugin "./plugin" internal error                              ␊
    ────────────────────────────────────────────────────────────────␊
...
> Snapshot 1
    ...
    ␊
      Error message␊
      Error: Deleting "netlifyConfig.build.ignore" is not allowed.␊
...
> Snapshot 1
    ...
    > Resolved config␊
      build:␊
        publish: packages/build/tests/plugins/fixtures/config_readonly_prevent␊
        publishOrigin: default␊
      functions:␊
        '*': {}␊
      plugins:␊
    ...
    ␊
      Error message␊
      Error: Using the "validateAnyProperty()" method on "netlifyConfig.build" is not allowed.␊
    ␊
      Plugin details␊
      Package:        ./plugin␊
      Version:        1.0.0␊
...
> Snapshot 1
    ...
    > Resolved config␊
      build:␊
        publish: packages/build/tests/plugins/fixtures/config_readonly_proto␊
        publishOrigin: default␊
      functions:␊
        '*': {}␊
      plugins:␊
    ...
    ␊
      Error message␊
      Error: Using the "setPrototypeOf()" method on "netlifyConfig.build" is not allowed.␊
    ␊
      Plugin details␊
      Package:        ./plugin␊
      Version:        1.0.0␊
...
> Snapshot 1
    ...
    ␊
      Error message␊
      Error: Deleting "netlifyConfig.build.command" is not allowed.␊
      Please set this property to a specific value instead.␊
    ␊
      Plugin details␊
      Package:        ./plugin.js␊
...
> Snapshot 1
    ...
    ────────────────────────────────────────────────────────────────␊
    ␊
    Netlify configuration property "functions.test" value changed to {}.␊
...
> Snapshot 1
    ...
    Netlify configuration property "functions.test.node_bundler" value changed to 'esbuild'.␊
...
> Snapshot 1
    ...
    Netlify configuration property "functionsDirectory" value changed to ''.␊
    ␊
    > Updated config␊
      build:␊
        publish: packages/build/tests/plugins/fixtures/config_mutate_functions_directory_skip␊
...
> Snapshot 1
    ...
    ────────────────────────────────────────────────────────────────␊
    ␊
    Netlify configuration property "build.processing" value changed to {␊
...
> Snapshot 1
    ...
    ────────────────────────────────────────────────────────────────␊
    ␊
    Netlify configuration property "build.processing.css" value changed to { bundle: true, minify: true }.␊
    ...
    Netlify configuration property "build.processing.html" value changed to { pretty_urls: true }.␊
    Netlify configuration property "build.processing.html.pretty_urls" value changed to true.␊
    Netlify configuration property "build.processing.images" value changed to { compress: true }.␊
    Netlify configuration property "build.processing.images.compress" value changed to true.␊
    Netlify configuration property "build.processing.js" value changed to { bundle: true, minify: true }.␊
...
> Snapshot 1
    ...
    ────────────────────────────────────────────────────────────────␊
    ␊
    Netlify configuration property "build.services" value changed to { identity: 'two' }.␊
    ␊
    > Updated config␊
      build:␊
        publish: packages/build/tests/plugins/fixtures/config_mutate_services_all␊
