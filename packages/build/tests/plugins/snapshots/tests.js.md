...
> Snapshot 1
    ...
    > Context␊
      production␊
    Warning: please ensure the following build plugins are compatible with Node.js 1.0.0: ./plugin.js. Those plugins are currently run with Node.js 1.0.0 and we will soon be changing it to always rely on our system's Node.js version (currently 1.0.0). For more info see - https://answers.netlify.com/t/breaking-change-using-system-node-version-to-run-build-plugins/38680␊
    ␊
    ────────────────────────────────────────────────────────────────␊
      Configuration error                                           ␊
    ────────────────────────────────────────────────────────────────␊
...
> Snapshot 1
    ...
    > Context␊
      production␊
    Warning: please ensure the following build plugins are compatible with Node.js 1.0.0: ./plugin. Those plugins are currently run with Node.js 1.0.0 and we will soon be changing it to always rely on our system's Node.js version (currently 1.0.0). For more info see - https://answers.netlify.com/t/breaking-change-using-system-node-version-to-run-build-plugins/38680␊
    ␊
    > Loading plugins␊
       - ./plugin@1.0.0 from netlify.toml␊
    ␊
