...
> Snapshot 1
    ...
    ␊
    ────────────────────────────────────────────────────────────────␊
      4. onPostBuild step from ./plugin                             ␊
    ────────────────────────────────────────────────────────────────␊
    ␊
    node --version␊
    [ 'test' ]␊
...
> Snapshot 1
    ...
    ␊
    ────────────────────────────────────────────────────────────────␊
      3. onPostBuild step from ./plugin                             ␊
    ────────────────────────────────────────────────────────────────␊
    ␊
    [ { for: '/external/path', values: { test: 'one' } } ]␊
    ␊
...
> Snapshot 1
    ...
    ␊
    ────────────────────────────────────────────────────────────────␊
      2. onPostBuild step from ./plugin                             ␊
    ────────────────────────────────────────────────────────────────␊
    ␊
    [␊
      { for: '/external/path', values: { test: 'three' } },␊
...
> Snapshot 1
    ...
    ␊
    ────────────────────────────────────────────────────────────────␊
      1. onPreBuild step from /external/path                             ␊
    ────────────────────────────────────────────────────────────────␊
    ␊
    . true␊
    ␊
...
> Snapshot 1
    ...
    ␊
    ────────────────────────────────────────────────────────────────␊
      2. onBuild step from @netlify/plugin-edge-handlers            ␊
    ────────────────────────────────────────────────────────────────␊
    ␊
...
> Snapshot 1
    ...
    ␊
    ────────────────────────────────────────────────────────────────␊
      3. onBuild step from @netlify/plugin-edge-handlers            ␊
    ────────────────────────────────────────────────────────────────␊
    ␊
...
> Snapshot 1
    ...
    ␊
    ────────────────────────────────────────────────────────────────␊
      1. onBuild step from @netlify/plugin-edge-handlers            ␊
    ────────────────────────────────────────────────────────────────␊
    ␊
...
> Snapshot 1
    ...
    ␊
    ────────────────────────────────────────────────────────────────␊
      2. onSuccess step from ./plugin.js                            ␊
    ────────────────────────────────────────────────────────────────␊
    ␊
    onSuccess␊
    ␊
...
> Snapshot 1
    ...
    ␊
    ────────────────────────────────────────────────────────────────␊
      2. onError step from ./handler_one.js                         ␊
    ────────────────────────────────────────────────────────────────␊
    ␊
    ␊
    ────────────────────────────────────────────────────────────────␊
    ...
    ␊
    ────────────────────────────────────────────────────────────────␊
      3. onError step from ./handler_two.js                         ␊
    ────────────────────────────────────────────────────────────────␊
    ␊
    onBuild␊
    ␊
...
> Snapshot 1
    ...
    ␊
    ────────────────────────────────────────────────────────────────␊
      2. onEnd step from ./handler_one.js                           ␊
    ────────────────────────────────────────────────────────────────␊
    ␊
    onEnd one␊
    ␊
    ...
    ␊
    ────────────────────────────────────────────────────────────────␊
      3. onEnd step from ./handler_two.js                           ␊
    ────────────────────────────────────────────────────────────────␊
    ␊
    onEnd two␊
    ␊
...
> Snapshot 1
    ...
    ␊
    ────────────────────────────────────────────────────────────────␊
      1. onPreBuild step from netlify-plugin-contextual-env         ␊
    ────────────────────────────────────────────────────────────────␊
    ␊
...
> Snapshot 1
    ...
    ␊
    ────────────────────────────────────────────────────────────────␊
      2. onPostBuild step from ./plugin.js                          ␊
    ────────────────────────────────────────────────────────────────␊
    ␊
    test␊
    ␊
...
> Snapshot 1
    ...
    ␊
    ────────────────────────────────────────────────────────────────␊
      2. onPreBuild step from ./plugin_two                          ␊
    ────────────────────────────────────────────────────────────────␊
    ␊
    one two en_US.UTF-8␊
    ␊
    ...
    ␊
    ────────────────────────────────────────────────────────────────␊
      4. onBuild step from ./plugin_two                             ␊
    ────────────────────────────────────────────────────────────────␊
    ␊
    one two en_US.UTF-8␊
    ␊
    ...
    ␊
    ────────────────────────────────────────────────────────────────␊
      5. onPostBuild step from ./plugin                             ␊
    ────────────────────────────────────────────────────────────────␊
    ␊
