...
> Snapshot 1
    ...
    ␊
    ┌───────────────────────────────────────────────────────────┐␊
    │ 1. onPostBuild command from @netlify/plugin-edge-handlers │␊
    └───────────────────────────────────────────────────────────┘␊
    ␊
    Packaging Edge handlers from custom-edge-handlers directory:␊
     - test␊
    ␊
    (@netlify/plugin-edge-handlers onPostBuild completed in 1ms)␊
    ␊
    ┌─────────────────────────────┐␊
    │   Netlify Build Complete    │␊
    └─────────────────────────────┘␊
...
> Snapshot 1
    ...
    └────────────────────────────────────────────────────────────┘␊
    ␊
    The Netlify Functions setting target a non-exiting directory: missing␊
    ␊
    (@netlify/plugin-functions-core onPostBuild completed in 1ms)␊
    ␊
    ┌─────────────────────────────┐␊
...
> Snapshot 1
    ...
    ␊
    ┌────────────────────────────────────────────────────────────────────┐␊
    │ 1. onPostBuild command from /file/path │␊
    └────────────────────────────────────────────────────────────────────┘␊
    ␊
    No Functions were found in functions directory␊
    ␊
...
> Snapshot 1
    ...
    ␊
    ┌───────────────────────────────────────────────────────────┐␊
    │ 2. onPostBuild command from @netlify/plugin-edge-handlers │␊
    └───────────────────────────────────────────────────────────┘␊
    ␊
...
> Snapshot 1
    ...
    ␊
      Error message␊
      Error: ENOENT: no such file or directory, scandir 'edge-handlers'␊
    ␊
      Plugin details␊
      Package:        @netlify/plugin-edge-handlers␊
      Version:        1.0.0␊
    ...
    ␊
      Error location␊
      In "onPostBuild" event in "@netlify/plugin-edge-handlers" from core␊
    ␊
      Error properties␊
      {␊
        errno: -2,␊
