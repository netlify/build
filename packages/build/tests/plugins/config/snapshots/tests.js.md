...
## plugin.inputs assign default values
...
## plugin.inputs is validated as a JSON schema 7
...
> Snapshot 1
    ...
    ␊
    > Error message␊
      Error: Plugin 'inputs' must be a JSON schema v1.0.0 describing each input.␊
...
## plugin.inputs is validated as an object
...
## plugin.inputs is validated as an object JSON schema
...
## plugin.inputs validates properties
...
> Snapshot 1
    ...
    ␊
    > Error message␊
      Error: Plugin inputs are invalid.␊
...
## plugin.inputs validates required properties
...
## plugin.inputs validates unknown properties
...
## plugin.inputs works with undefined inputs
...
## plugin.config backward compatibility
