...
> Snapshot 1
    ...
    ␊
      Error message␊
      Error: Command failed with exit code 1: deno bundle --import-map BASE64_STRING --quiet --code-splitting --allow-import --no-npm --node-modules-dir=manual --outdir /external/path packages/build/tests/edge_functions/fixtures/functions_invalid/netlify/edge-functions/functions-1.ts␊
    STACK TRACE␊
    ␊
        export async () => ␊
               ~~~~~␊
    ...
    ␊
      Error properties␊
      {␊
        shortMessage: 'Command failed with exit code 1: deno bundle --import-map BASE64_STRING --quiet --code-splitting --allow-import --no-npm --node-modules-dir=manual --outdir /external/path packages/build/tests/edge_functions/fixtures/functions_invalid/netlify/edge-functions/functions-1.ts',␊
        command: 'deno bundle --import-map BASE64_STRING --quiet --code-splitting --allow-import --no-npm --node-modules-dir=manual --outdir /external/path packages/build/tests/edge_functions/fixtures/functions_invalid/netlify/edge-functions/functions-1.ts',␊
        escapedCommand: 'deno bundle --import-map "BASE64_STRING" --quiet --code-splitting --allow-import --no-npm "--node-modules-dir=manual" --outdir "/external/path" "packages/build/tests/edge_functions/fixtures/functions_invalid/netlify/edge-functions/functions-1.ts"',␊
        exitCode: 1,␊
        signal: undefined,␊
