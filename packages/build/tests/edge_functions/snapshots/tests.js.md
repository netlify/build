...
> Snapshot 1
    ...
    ␊
      Error message␊
      Command failed with exit code 1: deno install --import-map /external/path --quiet --allow-import --node-modules-dir=manual --vendor --entrypoint functions-1.ts␊
      error: SyntaxError: Expected '{', got 'async'␊
        |␊
      2 | export async () => ␊
        |        ~~~~~␊
    STACK TRACE␊
...
> Snapshot 1
    ...
    Edge Functions manifest: {"bundles":[{"asset":"HEXADECIMAL_ID.tar.gz","format":"tar"}],"routes":[{"function":"function-1","pattern":"^/one/?$","excluded_patterns":[],"path":"/external/path"}],"post_cache_routes":[],"bundler_version":"1.0.0","layers":[],"import_map":"netlify:import-map","function_config":{},"bundling_timing":{"tarball_ms":80}}␊
    ␊
    (Edge Functions bundling completed in 1ms)␊
