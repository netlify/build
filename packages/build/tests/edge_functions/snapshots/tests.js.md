...
> Snapshot 1
    ...
    spawn deno ENOENT␊
    STACK TRACE␊
    No globalVersion or semver not satisfied. globalVersion: undefined, versionRange: 1.0.0 - 1.0.0␊
    Using cached Deno CLI from packages/build/tests/edge_functions/fixtures/functions_user/.netlify/plugins/deno-cli/deno␊
    getBinaryVersion failed Command failed with ENOENT: deno --version␊
    spawn deno ENOENT Error: Command failed with ENOENT: deno --version␊
    spawn deno ENOENT␊
    STACK TRACE␊
