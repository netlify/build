...
> Snapshot 1
    ...
    ␊
      Error message␊
      Error: Command failed with exit code 1: deno install --import-map BASE64_STRING --quiet --allow-import --no-npm --node-modules-dir=manual --vendor --entrypoint functions-1.ts␊
    ...
    ␊
      Error properties␊
      {␊
        shortMessage: 'Command failed with exit code 1: deno install --import-map BASE64_STRING --quiet --allow-import --no-npm --node-modules-dir=manual --vendor --entrypoint functions-1.ts',␊
        command: 'deno install --import-map BASE64_STRING --quiet --allow-import --no-npm --node-modules-dir=manual --vendor --entrypoint functions-1.ts',␊
        escapedCommand: 'deno install --import-map "BASE64_STRING" --quiet --allow-import --no-npm "--node-modules-dir=manual" --vendor --entrypoint functions-1.ts',␊
        exitCode: 1,␊
        signal: undefined,␊
