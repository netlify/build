...
> Snapshot 1
    ...
    ␊
      Error message␊
      Command failed with exit code 1: deno bundle --import-map=BASE64_STRING --quiet packages/build/tests/monitor/fixtures/edge_function_error/.netlify/edge-functions-dist/HEXADECIMAL_IDpre.js packages/build/tests/monitor/fixtures/edge_function_error/.netlify/edge-functions-dist/HEXADECIMAL_ID.js␊
      error: Module not found "packages/build/tests/monitor/fixtures/edge_function_error/netlify/edge-functions/file.ts".␊
    STACK TRACE␊
    ␊
      Error location␊
    ...
    {␊
      ...
      "errorMessage": "Command failed with exit code 1: deno bundle --import-map=BASE64_STRING --quiet packages/build/tests/monitor/fixtures/edge_function_error/.netlify/edge-functions-dist/HEXADECIMAL_IDpre.js packages/build/tests/monitor/fixtures/edge_function_error/.netlify/edge-functions-dist/HEXADECIMAL_ID.js/nerror: Module not found /"packages/build/tests/monitor/fixtures/edge_function_error/netlify/edge-functions/file.ts"./n    at packages/build/tests/monitor/fixtures/edge_function_error/netlify/edge-functions/trouble.ts:3:80",␊
      "context": "'Bundling of edge function failed",␊
      "groupingHash": "'Bundling of edge function failed/nCommand failed with exit code 0: deno bundle --import-map=dataURI --quiet /external/path /external/path Module not found /"/"./n    at /external/path",␊
      "severity": "info",␊
      "unhandled": false,␊
      "location": {␊
        "format": "javascript",␊
...
> Snapshot 1
    ...
    ␊
      ...
      Build failed with 2 errors:␊
        ...
        .netlify/functions-internal/server/node_modules/@vue-leaflet/vue-leaflet/dist/vue-leaflet.cjs.js:80:80: ERROR: No loader is configured for ".node" files: .netlify/functions-internal/server/node_modules/bar/dist/baz.node␊
    ␊
      Error location␊
