...
> Snapshot 1
    ...
    Packaging Functions from functions directory:␊
     - test.js␊
    ␊
    {"msg":"Functions bundling completed successfully","bundlers":["nft"],"bundlerCounts":{"nft":1},"fallbackCount":0,"warningsCount":0,"functions":[{"name":"test","runtime":"js","bundler":"nft","bundlerReason":"v1.0.0","sizeBytes":80,"hadFallback":false,"hadWarnings":false}]}␊
    ␊
...
> Snapshot 1
    ...
    ␊
      Error message␊
      Command failed with exit code 1: deno install --import-map /external/path --quiet --allow-import --node-modules-dir=manual --vendor --entrypoint trouble.ts␊
      error: Module not found "/external/path".␊
    STACK TRACE␊
    ␊
      Error location␊
    ...
    {␊
      ...
      "errorMessage": "Command failed with exit code 1: deno install --import-map /external/path --quiet --allow-import --node-modules-dir=manual --vendor --entrypoint trouble.ts/nerror: Module not found /"/external/path"./n    at /external/path",␊
      "context": "Bundling of edge function failed",␊
      "groupingHash": "Bundling of edge function failed/nCommand failed with exit code 0: deno install --import-map /external/path --quiet --allow-import --node-modules-dir=manual --vendor --entrypoint trouble.ts/nerror: Module not found /"/"./n    at /external/path",␊
      "severity": "info",␊
      "unhandled": false,␊
      "location": {␊
        "format": "tar",␊
