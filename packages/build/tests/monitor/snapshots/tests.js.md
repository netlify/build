...
> Snapshot 1
    ...
    ␊
      Error message␊
      Command failed with exit code 1: /external/path bundle --import-map=BASE64_STRING --no-config --quiet packages/build/tests/monitor/fixtures/edge_function_error/.netlify/edge-functions-dist/HEXADECIMAL_IDpre.js packages/build/tests/monitor/fixtures/edge_function_error/.netlify/edge-functions-dist/HEXADECIMAL_ID.js␊
    ...
    {␊
      ...
      "errorMessage": "Command failed with exit code 1: /external/path bundle --import-map=BASE64_STRING --no-config --quiet packages/build/tests/monitor/fixtures/edge_function_error/.netlify/edge-functions-dist/HEXADECIMAL_IDpre.js packages/build/tests/monitor/fixtures/edge_function_error/.netlify/edge-functions-dist/HEXADECIMAL_ID.js/nerror: Module not found /"packages/build/tests/monitor/fixtures/edge_function_error/netlify/edge-functions/file.ts"./n    at packages/build/tests/monitor/fixtures/edge_function_error/netlify/edge-functions/trouble.ts:3:80",␊
      "context": "Bundling of edge function failed",␊
      "groupingHash": "Bundling of edge function failed/nCommand failed with exit code 0: /external/path bundle --import-map=dataURI --no-config --quiet /external/path /external/path Module not found /"/"./n    at /external/path",␊
      "severity": "info",␊
      "unhandled": false,␊
      "location": {␊
        "format": "javascript",␊
