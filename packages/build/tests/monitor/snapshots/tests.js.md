...
> Snapshot 1
    ...
    > Flags␊
      debug: true␊
      repositoryRoot: packages/build/tests/monitor/fixtures/edge_function_error␊
      testOpts:␊
        errorMonitor: true␊
        pluginsListUrl: test␊
        silentLingeringProcesses: true␊
    ...
    ␊
      Error message␊
      Command failed with exit code 1: deno bundle --import-map=BASE64_STRING packages/build/tests/monitor/fixtures/edge_function_error/.netlify/edge-functions-dist/HEXADECIMAL_IDpre.js packages/build/tests/monitor/fixtures/edge_function_error/.netlify/edge-functions-dist/HEXADECIMAL_ID.js␊
    ...
    {␊
      ...
      "errorMessage": "Command failed with exit code 1: deno bundle --import-map=BASE64_STRING packages/build/tests/monitor/fixtures/edge_function_error/.netlify/edge-functions-dist/HEXADECIMAL_IDpre.js packages/build/tests/monitor/fixtures/edge_function_error/.netlify/edge-functions-dist/HEXADECIMAL_ID.js/nerror: Invalid file path./n  Specifier: file://bar//n    at file:///Users/eduardoboucas/Sites/netlify/build/packages/build/tests/monitor/fixtures/edge_function_error/netlify/edge-functions/trouble.ts:3:80",␊
      "context": "'Bundling of edge function failed",␊
      "groupingHash": "'Bundling of edge function failed/nCommand failed with exit code 0: deno bundle --import-map=dataURI /external/path /external/path Invalid file path./n  Specifier: /external/path    at /external/path",␊
      "severity": "info",␊
      "unhandled": false,␊
      "location": {␊
        "format": "javascript",␊
