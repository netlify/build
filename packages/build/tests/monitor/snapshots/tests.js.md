...
> Snapshot 1
    ...
    {␊
      ...
      "groupingHash": "'Bundling of edge function failed/nCommand failed with exit code 0: deno bundle --import-map=dataURI --quiet /external/path /external/path Invalid file path./n  Specifier: /external/path    at /external/path",␊
      "severity": "info",␊
      "unhandled": false,␊
      "location": {␊
        "format": "javascript",␊
