...
> Snapshot 1
    ...
    ────────────────────────────────────────────────────────────────␊
    ␊
    Writing deploy metadata to packages/build/tests/monitor/fixtures/monitor_fail_plugin/.netlify/deploy-metadata.json...␊
    Wrote deploy metadata to packages/build/tests/monitor/fixtures/monitor_fail_plugin/.netlify/deploy-metadata.json.␊
    ␊
...
> Snapshot 1
    ...
    ────────────────────────────────────────────────────────────────␊
    ␊
    Writing deploy metadata to packages/build/tests/monitor/fixtures/dependencies/.netlify/deploy-metadata.json...␊
    Wrote deploy metadata to packages/build/tests/monitor/fixtures/dependencies/.netlify/deploy-metadata.json.␊
    ␊
    (Deploy metadata completed in 1ms)␊
    Build step duration: Deploy metadata completed in 1ms␊
    ␊
