...
## Normalizes error messages resulting from functions bundling
...
> Snapshot 1
    ...
    > Flags␊
      debug: true␊
      repositoryRoot: packages/build/tests/monitor/fixtures/function_bundling_error␊
      testOpts:␊
        errorMonitor: true␊
        pluginsListUrl: test␊
        silentLingeringProcesses: true␊
    ␊
    > Current directory␊
      packages/build/tests/monitor/fixtures/function_bundling_error␊
    ␊
    > Config file␊
    ...
    > Resolved config␊
      build:␊
        publish: packages/build/tests/monitor/fixtures/function_bundling_error␊
        publishOrigin: default␊
      functionsDirectory: packages/build/tests/monitor/fixtures/function_bundling_error/netlify/functions␊
    ␊
    > Context␊
      production␊
    ␊
    ...
    ␊
      ...
      packages/build/tests/monitor/fixtures/function_bundling_error/netlify/functions/trouble.ts ERROR: Cannot assign to "bar" because it is a constant␊
    ␊
      Error location␊
    ...
    {␊
      ...
      "errorMessage": "Build failed with 1 error:/npackages/build/tests/monitor/fixtures/function_bundling_error/netlify/functions/trouble.ts ERROR: Cannot assign to /"bar/" because it is a constant",␊
      "context": "Bundling of function failed",␊
      "groupingHash": "Bundling of function failed/nBuild failed with 0 error:/n/file/path ERROR: Cannot assign to /"bar/" because it is a constant",␊
      "severity": "info",␊
      "unhandled": false,␊
      "location": {␊
