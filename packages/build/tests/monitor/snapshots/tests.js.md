...
> Snapshot 1
    ...
    ␊
      Error message␊
      Command failed with exit code 1: deno run --allow-all --no-config --quiet --import-map=/node_module/path /node_module/path {"basePath":"packages/build/tests/monitor/fixtures/edge_function_error","destPath":"packages/build/tests/monitor/fixtures/edge_function_error/.netlify/edge-functions-dist/HEXADECIMAL_ID.eszip","externals":[],"functions":[{"name":"trouble","path":"packages/build/tests/monitor/fixtures/edge_function_error/netlify/edge-functions/trouble.ts"}],"importMapURL":"BASE64_STRING"}␊
