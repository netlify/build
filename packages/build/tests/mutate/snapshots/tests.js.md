# Snapshot report for `packages/build/tests/mutate/tests.js`
...
> Snapshot 1
    ...
    > Flags␊
      debug: true␊
      repositoryRoot: packages/build/tests/mutate/fixtures/edge_functions_constants␊
      testOpts:␊
        pluginsListUrl: test␊
        silentLingeringProcesses: true␊
    ␊
    ...
    > Resolved config␊
      build:␊
        publish: packages/build/tests/mutate/fixtures/edge_functions_constants␊
        publishOrigin: default␊
      plugins:␊
        - inputs: {}␊
          origin: config␊
    ...
    > Updated config␊
      build:␊
        edge_functions: packages/build/tests/mutate/fixtures/edge_functions_constants/test␊
        publish: packages/build/tests/mutate/fixtures/edge_functions_constants␊
        publishOrigin: default␊
      plugins:␊
        - inputs: {}␊
    ...
    > Edge Functions Manifest␊
      {"bundles":[{"asset":"HEXADECIMAL_ID.js","format":"js"}],"routes":[],"bundler_version":"1.0.0"}␊
    ␊
    ␊
    (Edge Functions bundling completed in 1ms)␊
    ␊
    ────────────────────────────────────────────────────────────────␊
      4. Edge Functions manifest validation                         ␊
    ────────────────────────────────────────────────────────────────␊
    ␊
    ␊
    (Edge Functions manifest validation completed in 1ms)␊
    ␊
    ────────────────────────────────────────────────────────────────␊
      Netlify Build Complete                                        ␊
    ────────────────────────────────────────────────────────────────␊
...
> Snapshot 1
    ...
    > Flags␊
      debug: true␊
      repositoryRoot: packages/build/tests/mutate/fixtures/edge_functions_all␊
      testOpts:␊
        pluginsListUrl: test␊
        silentLingeringProcesses: true␊
    ␊
    ...
    > Resolved config␊
      build:␊
        publish: packages/build/tests/mutate/fixtures/edge_functions_all␊
        publishOrigin: default␊
      plugins:␊
        - inputs: {}␊
          origin: config␊
