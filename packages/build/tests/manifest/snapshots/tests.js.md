...
> Snapshot 1
    ...
    ␊
      Error message␊
      Unknown inputs for plugin "/file/path": "test"␊
...
> Snapshot 1
    ...
    ␊
      Error message␊
      The plugin "/file/path" is missing a "manifest.yml".␊
      This might mean:␊
...
> Snapshot 1
    ...
    ␊
      Error message␊
      Plugin "/file/path" does not accept any inputs but you specified: "one"␊
      Check your plugin configuration to be sure that:␊
        - the input name is spelled correctly␊
        - the input is included in the plugin's available configuration options␊
        - the plugin's input requirements have not changed␊
