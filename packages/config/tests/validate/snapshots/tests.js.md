...
> Snapshot 1
    ...
    Configuration property build.publish must be inside the build directory.␊
    ␊
    Invalid syntax␊
    ␊
      [build]␊
...
> Snapshot 1
    ...
    Configuration property functions.directory must be inside the build directory.␊
    ␊
    Invalid syntax␊
    ␊
      [functions]␊
...
> Snapshot 1
    ...
    Configuration property build.edge_handlers must be inside the build directory.␊
    ␊
    Invalid syntax␊
    ␊
      [build]␊
...
## functions.included_files: does not contain paths outside of the build directory

> Snapshot 1

    `When resolving config file packages/config/tests/validate/fixtures/function_config_invalid_included_files_2/netlify.toml:␊
    Configuration property functions.*.included_files[1] must be inside the build directory.␊
    ␊
    Invalid syntax␊
    ␊
      [functions]␊
