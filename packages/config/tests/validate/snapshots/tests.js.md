...
## build.environment: flat object

> Snapshot 1

    `When resolving config file packages/config/tests/validate/fixtures/build_environment_flat_object/netlify.toml:␊
    Configuration property build.environment must be a plain object.␊
    ␊
    Invalid syntax␊
    ␊
      [build]␊
    ...
    ␊
          ...
          TEST_1 = "https://api.example.com/production"␊
    ␊
    Valid syntax␊
    ␊
      [build]␊
