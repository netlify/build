...
> Snapshot 1
    ...
    `When resolving config file packages/config/tests/validate/fixtures/spa_fallback_boolean/netlify.toml:␊
    Configuration property spa_fallback must be a boolean.␊
    ␊
    Invalid syntax␊
    ␊
      spa_fallback = "true"␊
