...
## build.deno_import_map: string

> Snapshot 1

    `When resolving config file packages/config/tests/validate/fixtures/build_deno_import_map/netlify.toml:␊
    Configuration property build.deno_import_map must be a string.␊
    ␊
    Invalid syntax␊
    ␊
      [build]␊
