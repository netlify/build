...
## functions.\*.js_external_modules: array of strings

> Snapshot 1

    `When resolving config file /file/path␊
    Configuration property functions.*.js_external_modules must be an array of strings.␊
    ␊
    Invalid syntax␊
    ␊
      [functions]␊
    ␊
        [functions."*"]␊
        js_external_modules = "not-an-array"␊
    ␊
    Valid syntax␊
    ␊
      [functions]␊
...
## functions.\*.js_ignored_modules: array of strings

> Snapshot 1

    `When resolving config file /file/path␊
    Configuration property functions.*.js_ignored_modules must be an array of strings.␊
    ␊
    Invalid syntax␊
    ␊
      [functions]␊
