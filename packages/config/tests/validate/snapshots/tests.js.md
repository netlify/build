...
> Snapshot 1
    ...
    `{␊
      "accounts": [],␊
      "branch": "branch",␊
      "buildDir": "packages/config/tests/validate/fixtures/build_spa_boolean",␊
      "config": {␊
        "build": {␊
          "environment": {},␊
          "processing": {␊
          ...
          "publish": "packages/config/tests/validate/fixtures/build_spa_boolean/publish",␊
          "publishOrigin": "config",␊
          "services": {},␊
          "spa": "true"␊
        },␊
      ...
      "configPath": "packages/config/tests/validate/fixtures/build_spa_boolean/netlify.toml",␊
      "context": "production",␊
      "env": {␊
        "BRANCH": {␊
          "sources": [␊
      ...
      "headersPath": "packages/config/tests/validate/fixtures/build_spa_boolean/publish/_headers",␊
      "integrations": [],␊
      "redirectsPath": "packages/config/tests/validate/fixtures/build_spa_boolean/publish/_redirects",␊
      "repositoryRoot": "packages/config/tests/validate/fixtures/build_spa_boolean",␊
      "siteInfo": {}␊
    }`
...
## edge_functions.any.name: allowed in netlify.toml
...
> Snapshot 1
    ...
    `{␊
      "accounts": [],␊
      "branch": "branch",␊
      "buildDir": "packages/config/tests/validate/fixtures/edge_functions_name",␊
      "config": {␊
        "build": {␊
          "environment": {},␊
          "processing": {␊
          ...
          "publish": "packages/config/tests/validate/fixtures/edge_functions_name",␊
          "publishOrigin": "default",␊
          "services": {}␊
        },␊
        "edge_functions": [␊
      ...
      "configPath": "packages/config/tests/validate/fixtures/edge_functions_name/netlify.toml",␊
      "context": "production",␊
      "env": {␊
        "BRANCH": {␊
          "sources": [␊
      ...
      "headersPath": "packages/config/tests/validate/fixtures/edge_functions_name/_headers",␊
      "integrations": [],␊
      "redirectsPath": "packages/config/tests/validate/fixtures/edge_functions_name/_redirects",␊
      "repositoryRoot": "packages/config/tests/validate/fixtures/edge_functions_name",␊
      "siteInfo": {}␊
    }`

## edge_functions.any.generator: not allowed in netlify.toml

> Snapshot 1

    `When resolving config file packages/config/tests/validate/fixtures/edge_functions_reserved_generator/netlify.toml:␊
    Configuration property edge_functions[0] has unknown properties. Valid properties are:␊
      - path␊
      - excludedPath␊
      - pattern␊
