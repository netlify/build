...
## functions.import_map: is string

> Snapshot 1

    `When resolving config file packages/config/tests/validate/fixtures/function_config_invalid_import_map/netlify.toml:␊
    Configuration property functions.*.import_map must be a string.␊
    ␊
    Invalid syntax␊
    ␊
      [functions]␊
