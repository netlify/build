...
> Snapshot 1
    ...
    `When resolving config file /file/path␊
    Configuration property context.development.lifecycle.onBuild must be a string.␊
    ␊
    Invalid syntax␊
    ␊
      context:␊
...
> Snapshot 1
    ...
    `When resolving config file /file/path␊
    Configuration property build.lifecycle.onInit must be a string.␊
    ␊
    Invalid syntax␊
    ␊
      build:␊
...
> Snapshot 1
    ...
    `When resolving config file /file/path␊
    Configuration property build.lifecycle.onBuild must be a string.␊
    ␊
    Invalid syntax␊
    ␊
      build:␊
