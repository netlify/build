...
> Snapshot 1
    ...
    To publish the "base" directory instead, please set the "publish" directory to "packages/config"␊
    ␊
    ␊
    {␊
      "branch": "branch",␊
...
> Snapshot 1
    ...
    Warning: the "publish" directory was not set and will default to the repository root directory.␊
    To publish the root directory, please set the "publish" directory to "/"␊
    To publish the "base" directory instead, please set the "publish" directory to "subdir"␊
    ␊
    ␊
    {␊
      "branch": "branch",␊
