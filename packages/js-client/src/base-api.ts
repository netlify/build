...
export abstract class BaseAuth {
  ...
  scheme: NonNullable<APIOptions['scheme']>
  host: NonNullable<APIOptions['host']>
  pathPrefix: NonNullable<APIOptions['pathPrefix']>
  agent?: APIOptions['agent']
  globalParams: NonNullable<APIOptions['globalParams']> = {}
